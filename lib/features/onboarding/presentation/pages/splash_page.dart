...
class _OnboardingPageState extends ConsumerState<OnboardingPage> {
  ...
  final onboardingPages = const [
    ...
    _OnboardImageItem(
      ...
      description:
          "Selecione suas tags e gere um cardápio em segundos (RF-13).",
      assetPath: 'assets/images/onboarding2.png',
    ),
    _OnboardImageItem(
      title: "Sua Privacidade em Primeiro Lugar",
      description:
          "Todos os seus dados, como fotos e preferências, são salvos localmente e não são coletados por nós (RNF-2).",
      assetPath: 'assets/images/onboarding4.png',
    ),
    _OnboardImageItem(
      title: "Tudo Pronto!",
      description:
          "Poupe tempo e coma bem. Toque em 'Começar' para iniciar o seu planejamento.",
      assetPath: 'assets/images/onboarding4.png', //
    ),
  ];
